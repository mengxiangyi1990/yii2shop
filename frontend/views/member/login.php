	...
	<div class="topnav">
		<div class="topnav_bd w990 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到京西！[<a href="login.php">登录</a>] [<a href="<?=\yii\helpers\Url::to()?>">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
...
// 在键盘按下并释放及提交后验证提交表单
            $("#signupForm").validate({
                rules: {
                    ...
                    password: {
                        required: true,//用户名 必填
                     //   remote: "<?=\yii\helpers\Url::to(['member/validate-password'])?>"//验证用户名唯一
                    },
                    checkcode: {
                        required: true,
...
//                        remote: "密码错误,请重新输入"
        ...
        var hash;
        //获取验证码
        var captcha_url = '<?=\yii\helpers\Url::to(['member/captcha'])?>';
        //获取新验证码的url
