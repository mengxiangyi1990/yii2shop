    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href="<?=\yii\helpers\Url::to(['member/goods','id'=>$model->id])?>"><img src="<?=$model->logo?>" alt="" /></a></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['member/goods','id'=>$model->id])?>"><?=$model->name?></a></dt>
                        <dd><strong>￥<?=$model->shop_price?></strong></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['member/goods','id'=>$model->id])?>"><em>已有<?=$model->view_times?>次点击</em></a></dt>
                    </dl>
                </li>
                <?php endforeach;?>
            </ul>
