...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <dl id="del-dl" data-id="<?=$model->id?>">
                <dt><?=$model->id.'.&emsp;',$model->name.'.&emsp;',$model->address.'&emsp;',$model->tel.'&emsp;';?></dt>
                <dd>
        ...
        <div class="address_bd mt10">
            <h4>改修收货地址</h4>
            <form id="" action="" name="address_form" method="post">
                <ul>
                    <li>
                        <input type="hidden" name="id" value="<?=$new_address->id?>"/>
                        <label for=""><span>*</span>收 货 人：</label>
                        <input type="text" name="name" class="txt" value="<?=$new_address->name?>"/>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" name="address" class="address" value="<?=$new_address->address?>"/>
                    </li>
                    <li>
                        <label for=""><span>*</span>手机号码：</label>
                        <input type="tel" name="tel"  id="tel" value="<?=$new_address->tel?>"/>
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
...
$this->registerJs(new \yii\web\JsExpression(
    ...
    $(".address_hd").on('click','.del-btn',function() {
        var dl = $(this).closest("dl[id='del-dl']");
